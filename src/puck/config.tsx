  ...
  components: {
    ...
    Showcase: {
      render: () => {
        ...
        const tabs = [
          { id: "build", label: "الإنشاء", icon: <Icon.Sparkles /> },
          { id: "review", label: "المراجعة", icon: <Icon.Edit /> },
          { id: "analyze", label: "التحليل", icon: <Icon.Chart /> },
        ];
          ...
          <section className="section" style={{ position: "relative" }}>
            <div className="container">
              <div className="section-head">
                ...
                <h2 style={{ marginTop: 16 }}>منصّة مصمّمة للتميّز</h2>
                <p>كل ما يحتاجه المعلم — منظّمٌ، بصريٌّ، وسريع.</p>
              </div>
                ...
                {tabs.map((t) => (
                  <button
                    ...
                    style={{
                      ...
                      color: tab === t.id ? "var(--brand-on)" : "var(--text-muted)",
                      transition: "all 0.2s",
                    }}
                  >
              ...
              >
                ...
                <div style={{ minHeight: 460 }}>
                  {tab === "build" && <ShowcaseBuild />}
                  {tab === "review" && <ShowcaseReview />}
                  {tab === "analyze" && <ShowcaseAnalyze />}
                </div>
              </div>
            </div>
          </section>
        ...
        const items = [
          {
            ...
            role: "معلمة رياضيات · ثانوية",
            body: "كنت أقضي ٣ ساعات لإعداد اختبار. الآن في ١٠ دقائق بجودة أعلى ومستويات بلوم متوازنة.",
            avatar: "م",
          },
          {
            name: "د. عبدالله الحربي",
            role: "مدير مدرسة",
            body: "أدرنا اختبارات الفصل كاملةً عبر المنصة. التقارير على مستوى المادة والفصل غيّرت طريقة اتخاذ قراراتنا.",
            avatar: "ع",
          },
          {
            name: "أ. سارة القحطاني",
            role: "مشرفة لغة عربية",
            body: "الربط بنواتج التعلم الرسمية وفّر علينا أسابيع. أنصح به كل مشرف يبحث عن جودة وسرعة.",
            avatar: "س",
          },
          {
            name: "أ. خالد الزهراني",
            role: "معلم علوم · متوسطة",
            body: "تنويع الأسئلة تلقائياً ونماذج (A/B) جعل التصحيح عادلاً ومنع الغش — تحفة.",
            avatar: "خ",
          },
          {
            name: "م. هند الشمري",
            role: "منسّقة تقنيات تعليم",
            body: "تكاملٌ سلس مع نظام نور ومدرستي. لا تكرار إدخال، ولا أخطاء بشرية.",
            avatar: "ه",
          },
          {
            name: "أ. فهد البلوي",
            role: "معلم فيزياء",
            body: "دقة توليد الأسئلة في الفيزياء مذهلة، ومستوى التحليل البلومي يطابق ما نريده تماماً.",
            avatar: "ف",
          },
        ];

        return (
          <section id="cases" className="section" style={{ background: "var(--bg-elev-1)" }}>
            <div className="container">
              <div className="section-head">
                <div className="eyebrow">
                  <span className="dot" />
                ...
                <h2 style={{ marginTop: 16 }}>المعلمون يقولون</h2>
                <p>قصص من الميدان — معلمون ومدارس غيّروا طريقة عملهم مع اختباري.</p>
              </div>
              <div
              ...
              >
                {items.map((t, i) => (
                  <div
                    key={i}
                    className="card text-right"
                    style={{ padding: 28, background: "var(--bg)", position: "relative" }}
                  >
                    <Icon.Quote
                      width="28"
                      height="28"
                      style={{ color: "var(--brand)", opacity: 0.4, marginBottom: 14 }}
                    />
                    <p
                      style={{
                        fontSize: 15.5,
    ...
    FAQ: {
      render: () => {
        ...
        const items = [
          {
            q: "ما هي منصة اختباري؟",
            a: "اختباري منصة ذكاء اصطناعي تساعد المعلمين والمعلمات على إنشاء الاختبارات وأوراق العمل خلال أقل من دقيقة، وفق المنهج السعودي، مع إخراجها بصيغة PDF جاهزة للطباعة.",
          },
          {
          ...
          },
          {
            ...
            a: "غالبًا أقل من دقيقة واحدة، حسب عدد الأسئلة والإعدادات المختارة، ويمكنك المراجعة والتعديل بعدها.",
          },
          {
            q: "ما أنواع الأسئلة التي تدعمها المنصة؟",
            a: "تدعم المنصة أنواعًا متعددة: الاختيار من متعدد، الصح والخطأ، أكمل الفراغ، المزاوجة (صل)، علّل، الاستنتاج، والأسئلة المقالية وغيرها.",
          },
          {
            q: "هل توفر المنصة تصحيحًا آليًا للاختبارات؟",
            a: "نعم. تدعم المنصة الاختبارات الإلكترونية مع التصحيح الآلي وإظهار النتائج مباشرة، إضافة إلى تصحيح OMR للاختبارات الورقية.",
          },
          {
            q: "هل توجد نسخة مجانية؟",
            a: "نعم. توفر المنصة باقة مجانية تتيح تجربة إنشاء أوراق العمل والاختبارات بحدود معينة، والباقات المدفوعة تفتح التحليلات والمزايا المتقدمة.",
          },
        ];
          ...
          <section id="faq" className="section">
            <div className="container" style={{ maxWidth: 880 }}>
              <div className="section-head">
                ...
                <h2 style={{ marginTop: 16 }}>لديك سؤال؟ غالباً الجواب هنا.</h2>
              </div>
              <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                {items.map((it, i) => (
                  <div
                    key={i}
                    className="card"
                    style={{ padding: 0, overflow: "hidden", background: "var(--bg-elev-1)" }}
                  >
                    <button
                      type="button"
